...
const Trailers = ({classes}: { classes: Object }) =>
            ...
            <div className="trailer_main">
                <div className="chapter_header trailers_head">
                    ...
                    <div className="scroll-turn-preview">
                        <a className="scroll-turn-preview-left" href="#carouselTrailerIndicators" role="button"
                           data-slide="prev"/>
                        <a className="scroll-turn-preview-right" href="#carouselTrailerIndicators" role="button"
                           data-slide="next"/>
                    </div>
                </div>
                                            ...
                                            <div className="trailer_block_preview">
                                                <div className="flex_wrapper_left">
                                                    <div className="trailer_block_preview_img_wrapper">
                                                        ...
                                                        <img src={STATIC_PATH + "/img/trailers/trailer1.jpg"}
                                                             alt="img"/>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="trailer_block_preview">
                                                <div className="flex_wrapper_left">
                                                    <div className="trailer_block_preview_img_wrapper">
                                                        ...
                                                        <div className="trailer_block_preview_hover_color"/>
                                                        <img src={STATIC_PATH + "/img/trailers/trailer2.jpg"}
                                                             alt="img"/>
                                                    </div>
                                                </div>
                                                <div className="flex_wrapper_right">
                                            ...
                                            <div className="trailer_block_preview">
                                                <div className="flex_wrapper_left">
                                                    <div className="trailer_block_preview_img_wrapper">
                                                        ...
                                                        <div className="trailer_block_preview_hover_color"/>
                                                        <img src={STATIC_PATH + "/img/trailers/trailer3.jpg"}
                                                             alt="img"/>
                                                    </div>
                                                </div>
                                                <div className="flex_wrapper_right">
                                            ...
                                            <div className="trailer_block_preview">
                                                <div className="flex_wrapper_left">
                                                    <div className="trailer_block_preview_img_wrapper">
                                                        ...
                                                        <div className="trailer_block_preview_hover_color"/>
                                                        <img src={STATIC_PATH + "/img/trailers/trailer4.jpg"}
                                                             alt="img"/>
                                                    </div>
                                                </div>
                                                <div className="flex_wrapper_right">
                                            ...
                                            <div className="trailer_block_preview">
                                                <div className="flex_wrapper_left">
                                                    <div className="trailer_block_preview_img_wrapper">
                                                        ...
                                                        <div className="trailer_block_preview_hover_color"/>
                                                        <img src={STATIC_PATH + "/img/trailers/trailer5.jpg"}
                                                             alt="img"/>
                                                    </div>
                                                </div>
                                                <div className="flex_wrapper_right">
                                            ...
                                            <div className="trailer_block_preview">
                                                <div className="flex_wrapper_left">
                                                    <div className="trailer_block_preview_img_wrapper">
                                                        ...
                                                        <div className="trailer_block_preview_hover_color"/>
                                                        <img src={STATIC_PATH + "/img/trailers/trailer6.jpg"}
                                                             alt="img"/>
                                                    </div>
                                                </div>
                                                <div className="flex_wrapper_right">
...
export default injectSheet(styles)(Trailers);
