            ...
            <div>
                <Modal isOpen={this.props.modal} toggle={this.toggle} className={this.props.className}>
                    ...
                    <ModalFooter>
                        ...
                        <button type="submit" role="button" className="btn btn-success" disabled={this.props.submitting}>
                            Submit
                        </button>
                        <button
                            type="button" role="button" className="btn btn-warning" disabled={this.props.pristine || this.props.submitting}
                            onClick={this.props.reset}
                        >
                            Clear Values
                        </button>
                        <button type="button" role="button" className="btn btn-primary" onClick={this.onClose}>Close</button>
                    </ModalFooter>
                </form>
                </Modal>
            </div>
